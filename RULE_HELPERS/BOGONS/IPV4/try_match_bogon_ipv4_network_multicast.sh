...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address within 224.0.0.0/4 (Multicast Networks).\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 224.0.0.0/4 \\\\\n";

...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address of 255.255.255.255 (Broadcast).\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 255.255.255.255 \\\\\n";

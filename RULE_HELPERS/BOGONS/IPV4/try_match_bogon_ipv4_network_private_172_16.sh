...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address within 172.16.0.0/12 (Private Networks '172s Delegation').\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 172.16.0.0/12 \\\\\n";

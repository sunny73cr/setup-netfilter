...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address between 01:00:5E:00:00:00 and 01:00:5E:7F:FF:FF (inclusive) (IANA Assigned Multicast IPV4).\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE >= 01:00:5E:00:00:00 \\\\\n";
printf "\\t\\tether $MAC_ADDRESS_TYPE <= 01:00:5E:7F:FF:FF \\\\\n";

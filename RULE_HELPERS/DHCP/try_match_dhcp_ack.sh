...
print_usage() {
	...
	printf "  the IPV4 Address assigned to the DHCP server that will assign IPV4 Addresses to clients.\n">&2;
	printf "\n">&2;
	printf " Optional: --server-ipv4-network X.X.X.X/Y (where X is 0-255, and Y is 1-32)\n">&2;
	printf "  a contiguous block of IPV4 Address assigned to DHCP servers that will assign IPV4 Addresses to clients.\n">&2;
	printf "\n">&2;
	...
	printf "  the IPV4 Address assigned to the network client.\n">&2
	printf "\n">&2
	printf " Optional: --assigned-ipv4-network X.X.X.X/Y (where X is 0-255, and Y is 1-32)\n">&2
	printf "  a contiguous block of IPV4 Addresses that could be assigned to the network client.\n">&2
	printf "\n">&2
	printf " you cannot combine --assigned-ipv4-address and --assigned-ipv4-network\n">&2;
	printf "\n">&2;

...
printf "\\t#Match Source and Destination MAC address - who is informing their peers\n";
if [ -n "$MAC_ADDRESS_SOURCE" ]; then
	printf "\\t\\t@$OFFSET_MARKER,$BIT_OFFSET_ARP_SENDING_HARDWARE_ADDRESS,48 $MAC_ADDRESS_SOURCE_CLEANED \\\\\n";
	printf "\\t\\t@$OFFSET_MARKER,$BIT_OFFSET_ARP_TARGET_HARDWARE_ADDRESS,48 $MAC_ADDRESS_SOURCE_CLEANED \\\\\n";
else

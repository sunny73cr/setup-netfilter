...
if [ -n "$CLIENT_PORT" ]; then
	CMD_TRY_MATCH_UDP_HEADER="$CMD_TRY_MATCH_UDP_HEADER --source-port $CLIENT_PORT";
fi
if [ -n "$SERVER_PORT" ]; then
	CMD_TRY_MATCH_UDP_HEADER="$CMD_TRY_MATCH_UDP_HEADER --destination-port $SERVER_PORT";
fi

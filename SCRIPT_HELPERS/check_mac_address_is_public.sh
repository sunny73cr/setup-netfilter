...
print_usage_and_exit () {
	echo "Usage: $0 --address XX:XX:XX:XX:XX:XX, where X is a-f, A-F, or 0-9: hexadecimal.">&2;
	exit 2;
}
...
case $? in
	0) ;;
	1) printf "$0: the mac address you provided in invalid. It must be in the form XX:XX:XX:XX:XX:XX, where X is a-f, or A-F or 0-9.\n">&2; exit 2; ;;

...
case $? in
	0) ;;
	1) printf "$0: you provided an invalid mac address. It must be in the form XX:XX:XX:XX:XX:XX, where X is a-f, or A-F, or 0-9: hexadecimal.">&2; exit 2; ;;
	*) printf "$0: script dependency failure: \"\" produced a failure status code.">&2; exit 3; ;;
esac

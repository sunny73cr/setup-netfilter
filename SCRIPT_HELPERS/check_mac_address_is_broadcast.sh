...
print_description() {
	printf "A program that confirms or denies if a MAC address is the broadcast address (FF:FF:FF:FF:FF:FF).\n">&2;
}
...
print_usage() {
	...
	printf "  The MAC address to check. If the MAC address is invalid an exit code of 2 is returned.\n">&2;
	printf "\n">&2;

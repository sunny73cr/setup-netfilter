...
print_usage_and_exit () {
	printf "Usage: $0 --address XX:XX:XX:XX:XX:XX, where X is a-f, A-F, or 0-9: hexadecimal.\n">&2;
	exit 2;
}
...
case $? in
	0) ;;
	1) printf "$0: the mac address you supplied is invalid. It must be in the form XX:XX:XX:XX:XX:XX, where X is a-f, or A-F, or 0-9: hexadecimal.\n">&2; exit 2; ;;
	*) printf "$0: script dependency failure: \"\" produced a failure exit code.\n">&2; exit 3; ;;
esac

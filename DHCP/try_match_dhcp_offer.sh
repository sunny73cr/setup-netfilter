...
print_usage() {
	...
	printf "  the IPV4 Address offered to the DHCP server that will assign IPV4 Addresses to clients.\n">&2;
	printf "\n">&2;
	printf " Optional: --server-ipv4-network X.X.X.X/Y (where X is 0-255, and Y is 1-32)\n">&2;
	printf "  a contiguous block of IPV4 Address offered to DHCP servers that will assign IPV4 Addresses to clients.\n">&2;
	printf "\n">&2;
	...
	printf "  the IPV4 Address offered to the network client.\n">&2
	printf "\n">&2
	printf " Optional: --offered-ipv4-network X.X.X.X/Y (where X is 0-255, and Y is 1-32)\n">&2
	printf "  a contiguous block of IPV4 Addresses that could be offered to the network client.\n">&2
	printf "\n">&2
	printf " you cannot combine --offered-ipv4-address and --offered-ipv4-network\n">&2;
	printf "\n">&2;
	...
	printf "  it is stronly recommended to supply the user ID that is offered to the DHCP server 'service' listed in the /etc/passwd file.\n">&2;
	printf "  without this restriction, DHCP OFFER packets are permitted to any program.\n";
	printf "\n">&2;

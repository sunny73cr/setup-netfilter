...
echo "\t\tether $ETHER_ADDRESS_TYPE >= 00:00:5E:00:01:00 \\";
echo "\t\tether $ETHER_ADDRESS_TYPE <= 00:00:5E:00:01:FF \\";
echo "\t\tlog level warn \\";
echo "\t\tlog prefix \"Block Bogon MAC $ADDRESS_TYPE address IANA OUI Virtual Router Redundancy Protocol IPV4 00:00:5E:00:01:00 to 00:00:5E:00:01:FF - \" \\";
echo "\t\tdrop;";

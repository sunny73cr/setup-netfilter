...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address between 00:00:5E:00:54:00 and 00:00:5E:90:00:FF (inclusive) (IANA Reserved Unicast Range '6').\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE >= 00:00:5E:00:54:00 \\\\\n";
printf "\\t\\tether $MAC_ADDRESS_TYPE <= 00:00:5E:90:00:FF \\\\\n";

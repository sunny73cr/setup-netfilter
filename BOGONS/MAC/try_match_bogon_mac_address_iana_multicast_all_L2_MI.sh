...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address of 01:00:5E:90:00:03 (IANA Assigned 'All Layer 2 Management Interfaces').\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE 01:00:5E:90:00:03 \\\\\n";

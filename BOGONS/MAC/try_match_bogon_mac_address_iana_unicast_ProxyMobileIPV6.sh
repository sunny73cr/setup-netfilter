...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address of 00:00:5E:00:52:13 (Proxy Mobile IPV6).\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE 00:00:5E:00:52:13 \\\\\n";

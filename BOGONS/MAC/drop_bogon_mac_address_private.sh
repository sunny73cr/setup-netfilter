...
echo "\t\tether $MAC_ADDRESS_TYPE & 02:00:00:00:00:00 != 00:00:00:00:00:00 \\";
echo "\t\tlog prefix \"Block Bogon MAC $ADDRESS_TYPE address - Private MAC (Most significant octet 2nd LSB is 1) - \" \\";
echo "\t\tlog level warn \\";

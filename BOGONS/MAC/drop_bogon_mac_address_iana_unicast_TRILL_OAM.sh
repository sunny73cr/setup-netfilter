...
echo "\t\tether $ETHER_ADDRESS_TYPE = 00:00:5E:90:01:00 \\";
echo "\t\tlog level warn \\";
echo "\t\tlog prefix \"Block Bogon MAC $ADDRESS_TYPE address IANA OUI Transparent Interconnection of Lots Of Links Operation Administration Management 00:00:5E:90:01:00 - \" \\";
echo "\t\tdrop;";

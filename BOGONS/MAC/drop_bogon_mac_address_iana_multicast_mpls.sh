...
echo "\t\tether $ADDRESS_TYPE >= 01:00:5E:80:00:00 \\";
echo "\t\tether $ADDRESS_TYPE <= 01:00:5E:8F:FF:FF \\";
echo "\t\tlog level warn \\";
echo "\t\tlog prefix \"Block Bogon MAC Address IANA OUI Multicast MPLS 01:00:5E:80:00:00 to 01:00:5E:8F:FF:FF - \" \\";
echo "\t\tdrop;";

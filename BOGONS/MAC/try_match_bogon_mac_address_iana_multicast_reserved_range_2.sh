...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address of 01:00:5E:90:01:01 and 01:00:5E:90:01:FF (inclusive) (IANA Reserved Range '2').\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE >= 01:00:5E:90:01:01 \\\\\n";
printf "\\t\\tether $MAC_ADDRESS_TYPE <= 01:00:5E:90:01:FF \\\\\n";

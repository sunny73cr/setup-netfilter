...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address between 00:00:5E:00:02:00 and 00:00:5E:00:02:FF (inclusive) (IANA Unicast Virtual Router Redundancy Protocol IPV6).\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE >= 00:00:5E:00:02:00 \\\\\n";
printf "\\t\\tether $MAC_ADDRESS_TYPE <= 00:00:5E:00:02:FF \\\\\n";

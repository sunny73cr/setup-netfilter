...
echo "\t\tether $ETHER_ADDRESS_TYPE = 01:00:5E:90:00:00 \\";
echo "\t\tlog level warn \\";
echo "\t\tlog prefix \"Block Bogon MAC $ADDRESS_TYPE address IANA OUI Multicast MPLS Transport Profile Next Hop 01:00:5E:90:00:00 - \" \\";
echo "\t\tdrop;";

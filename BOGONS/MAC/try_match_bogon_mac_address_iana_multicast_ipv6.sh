...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address between 33:33:00:00:00:00 and 33:33:FF:FF:FF:FF (inclusive) (IANA Reserved Multicast IPV6).\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE >= 33:33:00:00:00:00 \\\\\n";
printf "\\t\\tether $MAC_ADDRESS_TYPE <= 33:33:FF:FF:FF:FF \\\\\n";

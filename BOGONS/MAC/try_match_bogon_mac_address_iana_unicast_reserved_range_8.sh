...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address between 00:00:5E:90:02:00 and 00:00:5E:FF:FF:FF (inclusive) (IANA Reserved Unicast Range '8').\n">&2;
}
...
echo "\\t\\tether $MAC_ADDRESS_TYPE >= 00:00:5E:90:02:00 \\\\\n";
echo "\\t\\tether $MAC_ADDRESS_TYPE <= 00:00:5E:FF:FF:FF \\\\\n";

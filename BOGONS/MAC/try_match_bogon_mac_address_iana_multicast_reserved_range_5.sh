...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination MAC (ether) address between 01:00:5E:90:11:00 and 01:00:5E:FF:FF:FF (reserved) (IANA Reserved Range '5').\n">&2;
}
...
printf "\\t\\tether $MAC_ADDRESS_TYPE >= 01:00:5E:90:11:00 \\\\\n";
printf "\\t\\tether $MAC_ADDRESS_TYPE <= 01:00:5E:FF:FF:FF \\\\\n";

...
echo "\t\tether $ETHER_ADDRESS_TYPE >= 01:00:5E:00:00:00 \\";
echo "\t\tether $ETHER_ADDRESS_TYPE <= 01:00:5E:7F:FF:FF \\";
echo "\t\tlog level warn \\";
echo "\t\tlog prefix \"Block Bogon MAC $ADDRESS_TYPE address IANA OUI Multicast IPV4 01:00:5E:00:00:00 to 01:00:5E:7F:FF:FF - \" \\";
echo "\t\tdrop;";

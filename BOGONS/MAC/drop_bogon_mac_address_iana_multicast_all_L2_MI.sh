...
echo "\t\tether $ETHER_ADDRESS_TYPE = 01:00:5E:90:00:03 \\";
echo "\t\tlog level warn \\";
echo "\t\tlog prefix \"Block Bogon MAC $ADDRESS_TYPE address IANA OUI Multicast All Layer 2 Multi Instance Intermediate Systems 01:00:5E:90:00:02 - \" \\";
echo "\t\tdrop;";

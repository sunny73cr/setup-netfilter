...
echo "\t\tip $IP_ADDRESS_TYPE 192.175.148.0/24 \\";
echo "\t\tlog prefix \"Block Bogon IPV4 $ADDRESS_TYPE address - AS112 V4 Direct Delegation 192.175.148.0 - 192.175.148.255 - \" \\";
echo "\t\tlog level warn \\";

...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address within 203.0.113.0/24 (Test Network 3).\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 203.0.113.0/24 \\\\\n";

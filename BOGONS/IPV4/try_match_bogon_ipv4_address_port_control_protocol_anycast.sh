...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address of 192.0.0.9 (Port Control Protocol Anycast).\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 192.0.0.9 \\\\\n";

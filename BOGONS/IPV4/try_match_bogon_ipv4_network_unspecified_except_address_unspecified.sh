...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address within 0.0.0.1 - 0.255.255.255 (Unspecified networks, except the special 'unspecified address').\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE { 0.0.0.1 - 0.255.255.255 } \\\\\n";

...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address within 100.64.0.0/10 (Shared Address Space '100.64s delegation' / 'ISP Addresses').\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 100.64.0.0/10 \\\\\n";

...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address within 198.18.0.0/15 (Benchmarking networks).\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 198.18.0.0/15 \\\\\n";

...
print_description() {
	printf "A program that prints a portion of an NFT rule match section. The match identifies packets with a source or destination IPV4 address within 192.168.0.0/16 (Private Networks '192.168s Delegation').\n">&2;
}
...
printf "\\t\\tip $IPV4_ADDRESS_TYPE 192.168.0.0/16 \\\\\n";
